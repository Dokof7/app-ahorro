...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <select id="filterCycle" class="form-control form-control-sm select2" style="width: 120px; display: inline-block;">
    ...
    <div class="card-body">
        <table class="table table-bordered table-striped" id="membersTable">
            <thead>
                <tr><th>Nombre</th><th>CI/Documento</th><th>Teléfono</th><th>Grupo</th><th>Ingreso</th><th>Ciclo</th><th>Estado</th><th>Acciones</th></tr>
            </thead>
        </table>
    </div>
</div>
...
var table = $('#membersTable').DataTable({
    ...
    ajax: { url: '{{ route("members.index") }}', data: function(d) { d.group_id = $('#filterGroup').val(); d.cycle = $('#filterCycle').val(); } },
    columns: [
        { data: 'full_name' }, { data: 'document_number', defaultContent: '-' },
        { data: 'phone', defaultContent: '-' }, { data: 'group_name' },
        { data: 'join_date' }, { data: 'cycle_badge', orderable: false },
...
$('#filterCycle').on('change', function() { table.ajax.reload(); });
</script>
@endpush
